...
Then debe mostrarse ventana con error "No se pudo guardar debido a: *El campo \'Documento de identidad\' no se encuentra entre nuestros doctores" 
...
Given El usuario ingresa a la url and hace click en Agendar cita
And existe el paciente con cedula 321 
...
And El usuario ingresa "Cita de medicina general" en el campo Observaciones
And El usuario hace click en el boton guardar
Then debe mostrarse ventana con mensaje "Datos guardados correctamente"
...
And El usuario ingresa "Cita de medicina general" en el campo Observaciones
And El usuario hace click en el boton guardar
Then debe mostrarse ventana con error "No se pudo guardar debido a: *El campo \'Documento de identidad\' no se encuentra entre nuestros pacientes registrados"
...
And El usuario ingresa "Cita de medicina general" en el campo Observaciones
And El usuario hace click en el boton guardar
Then debe mostrarse ventana con error HTTP ERROR 500
...
And El usuario ingresa "Cita de medicina general" en el campo Observaciones
And El usuario hace click en el boton guardar
Then debe mostrarse ventana con mensaje de error "Se deben usar fechas mayores a la fecha actual."